package hanivan.mokalemesgha.contacts;
...
import hanivan.mokalemesgha.BuildConfig;
import hanivan.mokalemesgha.MainActivity;
...
public class ContactProvider {
    ...
    public static void sendnotification(Context ctx) {
        ...
        notifyBuilder.setContentTitle(ctx.getString(R.string.app_name));
        notifyBuilder.setSmallIcon(R.mipmap.ic_launcher);
        notifyBuilder.setContentText(ctx.getString(R.string.We_are_recording_your_call));
    ...
    public static void sendnotificationOnEnd(Context ctx) {
        ...
        notifyBuilder.setContentTitle(ctx.getString(R.string.app_name));
        notifyBuilder.setSmallIcon(R.mipmap.ic_launcher);
        notifyBuilder.setContentText(ctx.getString(R.string.We_have_recorded_your_call));
        //notifyBuilder.setTicker("New message");
        Intent notificationIntent = new Intent(ctx, MainActivity.class);
        PendingIntent contentIntent = PendingIntent.getActivity(ctx, 0, notificationIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public static void openMaterialSheetDialog(LayoutInflater inflater, final int position, final String recording, final String contacts) {
        ...
        if (checkFav(view.getContext(), contacts)) {
            //set text remove
            favorite.setText(R.string.Add_to_favourite);
        } else {
            //set text add
            favorite.setText(R.string.Remove_from_favourtie);
        }
        if (checkContactToRecord(view.getContext(), contacts)) {
            turnoff.setText(R.string.Turn_off_recording);
        } else {
            turnoff.setText(R.string.Turn_on_recording);
        }
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (file.delete()) {
                    ...
                    Toast.makeText(view.getContext(), R.string.File_deleted_Successfully, Toast.LENGTH_SHORT).show();
                } else {
                    //not deleted
                    // itemdelete.deleterefreshList(true);
                    Toast.makeText(view.getContext(), R.string.Deletion_failed, Toast.LENGTH_SHORT).show();
                }
                materialSheet.dismiss();
            }
        });
        ...
        favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkFavourite(view.getContext(), contacts)) {
                    Toast.makeText(view.getContext(), R.string.added_to_favourite, Toast.LENGTH_SHORT).show();
                    itemrefresh.refreshList(true);
                } else {
                    itemrefresh.refreshList(true);
                    Toast.makeText(view.getContext(), R.string.removed_from_favourite, Toast.LENGTH_SHORT).show();
                }
                materialSheet.dismiss();
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (checkContactToRecord(view.getContext(), contacts)) {
                    ...
                    if (!togglestate(view.getContext(), contacts)) {
                        //off
                        Toast.makeText(view.getContext(), R.string.turned_off, Toast.LENGTH_SHORT).show();
                        itemrefresh.refreshList(true);
                    }
                } else {
                    if (togglestate(view.getContext(), contacts)) {
                        Toast.makeText(view.getContext(), R.string.turned_on, Toast.LENGTH_SHORT).show();
                        itemrefresh.refreshList(true);
                    }
