package hanivan.mokalemesgha.adapter;
...
import hanivan.mokalemesgha.Persian.DateToPersian;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()){
            ...
            case VIEW3:
                ...
                if(time=="1"){
                    ((MytimeViewHolder3)holder).time.setText(R.string.today);
                }else if(time=="2"){
                    ((MytimeViewHolder3)holder).time.setText(R.string.yesterday);
                }else{
                    //((MytimeViewHolder3)holder).time.setText(time);
                    ((MytimeViewHolder3)holder).time.setText(DateToPersian.getCurrentShamsidate(time));
...
//    DateToPersian.
    ...
    // String persianCalender = DateToPersian.getCurrentShamsidate(DateUtil.formatDate(DateUtil.FORMAT_DATE, mConsumerDetail.getConsumptionTime()));
