    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case VIEW3:
                ...
                if(time=="1"){
                    ((MytimeViewHolder2)holder).time.setText(R.string.today);
                }else if(time=="2"){
                    ((MytimeViewHolder2)holder).time.setText(R.string.yesterday);
                }else{
                    //((MytimeViewHolder2)holder).time.setText(time);
                    ((MytimeViewHolder2)holder).time.setText(DateToPersian.getCurrentShamsidate(time));
